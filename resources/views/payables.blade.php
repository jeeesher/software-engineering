            ...
            <div class="flex items-center ml-auto">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 relative">
                    <div class="custom-dropdown inline-flex items-center relative">
                        ...
                        <div class="custom-dropdown-content mt-2" style="width: 170px;">
                            <div class="px-4 py-3 text-sm text-zinc-950 font-semibold dark:text-white">
                                <div>Select Payable Year</div>
                            </div>
                            <hr class="border-gray-200 dark:border-gray-700 ">
                            
                            <div class="custom-option" data-value="2022-2023">
                                <div class="option-content justify-between">
                                    <div class="text">2022-2023</div>
                                    <div class="svg-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <div class="custom-option" data-value="2020-2021">
                                <div class="option-content justify-between">
                            ...
                            <div class="custom-option" data-value="2018-2019">
                                <div class="option-content justify-between">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 relative">
                    <div class="custom-dropdown inline-flex items-center relative">
                        ...
                        <div class="custom-dropdown-content mt-2" style="width: 161px;">
                            <div class="px-4 py-3 text-sm text-zinc-950 font-semibold dark:text-white">
                                <div>Select due</div>
                            </div>
                            ...
                            <div class="custom-option" data-value="Due next year">
                                <div class="option-content justify-between">
                                    <div class="text">Due next year</div>
                                    <div class="svg-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path d="M13.3334 4L6.00008 11.3333L2.66675 8" stroke="#71717A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                            ...
                            <div class="custom-option" data-value="Due this year">
                                <div class="option-content justify-between">
                                    <div class="text">Due this year</div>
                                    <div class="svg-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path d="M13.3334 4L6.00008 11.3333L2.66675 8" stroke="#71717A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                            ...
                            <div class="custom-option" data-value="Due next 2 years">
                                <div class="option-content  justify-between">
                                    <div class="text">Due next 2 years</div>
                                    <div class="svg-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path d="M13.3334 4L6.00008 11.3333L2.66675 8" stroke="#71717A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
