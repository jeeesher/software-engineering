    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        <div class="w-72 h-96 left-0 top-[114px] absolute">
            ...
            <div class="left-[335.12px] top-[126.50px] absolute text-black text-2xl font-medium font-['Nunito Sans'] leading-9">Tracking
                ...
                <!-- Filter Button -->
                <div class="left-[1020px] absolute w-20 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-center items-center gap-2 inline-flex hover:bg-gray-100">
                    <button class="w-4 h-4 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <button class="relative flex jutify-center items-center text-zinc-950 text-sm font-medium font-['Inter'] leading-tight border shadow group">
                        <p>Filter</p>
                ...
                <!-- Export Button -->
                <div class="left-[1123px] absolute w-24 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-center items-center gap-2 inline-flex hover:bg-gray-100">
                    <button class="w-4 h-4 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M2.66681 9.93284C2.17151 9.42679 1.79786 8.81465 1.57417 8.1428C1.35048 7.47095 1.28262 6.75701 1.37572 6.05504C1.46882 5.35308 1.72045 4.68151 2.11154 4.0912C2.50263 3.50089 3.02293 3.00732 3.63303 2.64788C4.24313 2.28843 4.92703 2.07255 5.63292 2.01656C6.33882 1.96058 7.04819 2.06597 7.70732 2.32475C8.36645 2.58353 8.95805 2.98892 9.4373 3.5102C9.91655 4.03149 10.2709 4.655 10.4735 5.33351H11.6668C12.3105 5.33344 12.9371 5.54039 13.4541 5.9238C13.9712 6.30722 14.3512 6.84675 14.538 7.46271C14.7248 8.07868 14.7086 8.7384 14.4917 9.34443C14.2748 9.95045 13.8687 10.4707 13.3335 10.8282M8.00008 8.00018V14.0002M8.00008 14.0002L5.33341 11.3335M8.00008 14.0002L10.6667 11.3335" stroke="#18181B" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                    <button class="text-zinc-950 text-sm font-medium font-['Inter'] leading-tight">Export</button>
                </div>

                <!-- Table -->
                <div class="w-200 h-96 relative top-[65px] absolute">
