        ...
        <!-- Background -->
            ...
            <div style="width: 40%; height: 50vh; position: relative">
                ...
                <div style="width: 40%; height: 50vh; left: 5%; top: 5%; position: absolute; border-radius: 12.49px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 5%; display: inline-flex">
                    ...
                    <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: center; gap: 5%;">
                        <!-- PLM Logo and Header Image -->
                        <div style="width: 100%; max-width: 427.12px; height: 84.92px; left: 80%; top: 7%; position: absolute; display: flex; flex-direction: row; align-items: flex-start; gap: 5%;">
                            <div style="width: 70%; aspect-ratio: 1; border-radius: 12.49px; overflow: hidden;">
                                <img style="width: 100%; height: 100%; object-fit: cover; border-radius: 12.49px;" src="{{ asset('css/images/image 5.png') }}" alt="PLM Logo">
                            </div>
                            <div style="flex: 1; aspect-ratio: 1; overflow: hidden;">
                                <img style="width: 100%; height: 100%; object-fit: cover; border-radius: 12.49px;" src="{{ asset('css/images/image 4.png') }}" alt="PLM Header">
                            </div>
                        </div>

                        <!-- PLM Module and Sign In Title -->
                        <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: center; gap: 3%;">
                            <div style="width: 100%; color: #2D6B9A; font-size: 4vw; font-family: Inter; font-weight: 700; line-height: 1.5; word-wrap: break-word">PLM Module</div>
                            <div style="width: 100%; color: #2D6B9A; font-size: 2vw; font-family: Inter; font-weight: 500; line-height: 0.8; word-wrap: break-word">Sign In</div>
                        </div>

                        <!-- Input Fields -->
                        <div style="flex-direction: column; justify-content: flex-start; align-items: center; gap: 5vw; display: flex">
                            <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 5vw; display: flex">
                                <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 5vw; display: flex">
                                    <!-- Email Address Input -->
                                    <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 2.5vw; display: flex">
                                        <div style="max-width: 500px; height: 29.97px; color: #191D23; font-size: 20px; font-family: Inter; font-weight: 400; line-height: 36px; word-wrap: break-word">Email Address</div>
